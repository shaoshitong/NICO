...
class Track1DataSet(DGDataSet):
    def __init__(self,
        ...
        super(Track1DataSet,self).__init__(mode,valid_category,label2id_path,test_image_path,train_image_path,transform_type)
        if mode == 'test':
...
class Track2DataSet(DGDataSet):
    def __init__(self,
        ...
        super(Track2DataSet,self).__init__(mode,valid_category,label2id_path,test_image_path,train_image_path,transform_type)
        if mode == 'test':
            self.images = get_test_set_images(test_image_path)
        if mode == 'train':
